      ...
      <header className="border-b border-base-300 pb-3 flex flex-col sm:flex-row sm:items-end justify-between gap-3">
        ...
        <div className="flex flex-row items-center gap-2 w-full sm:w-auto mt-3 sm:mt-0">
          ...
          <div className="dropdown dropdown-bottom sm:dropdown-end flex-1 sm:flex-none min-w-0">
            <label tabIndex={0} className="w-full h-8 rounded-none border border-base-300 bg-base-100 hover:bg-base-200 hover:border-primary text-[10px] font-mono uppercase font-bold tracking-widest flex px-2 sm:px-3 justify-between items-center cursor-pointer appearance-none transition-colors"><div className="flex items-center min-w-0"><Filter className="w-3 h-3 mr-1 shrink-0" /> <span className="truncate">{filter === 'all' ? 'Filter' : 'Filtered'}</span></div></label>
          ...
          <div className="dropdown dropdown-bottom sm:dropdown-end flex-1 sm:flex-none min-w-0">
            <label tabIndex={0} className="w-full h-8 rounded-none border border-base-300 bg-base-100 hover:bg-base-200 hover:border-primary text-[10px] font-mono uppercase font-bold tracking-widest flex px-2 sm:px-3 justify-between items-center cursor-pointer appearance-none transition-colors"><span className="truncate">Sort: {sort}</span></label>
